    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <h3 class="text-lg font-medium mb-4" style="color: #f3f4f6;">Loan List</h3>
                ...
                <div class="flex flex-wrap items-center justify-between gap-3 mb-6">
                    ...
                    <form method="GET" action="{{ route('loans.index') }}" class="flex items-center gap-2" id="search-form">
                        <input type="text" 
                               name="search" 
                               value="{{ $search }}" 
                    ...
                    <table style="width: 100%; border-collapse: collapse; background-color: #1f2937;">
                        <thead>
                            <tr style="border-bottom: 2px solid #374151; background-color: #e5e7eb;">
                                ...
                                <th style="text-align: left !important; padding: 12px 15px; font-size: 12px; color: #111827; font-weight: 700; text-transform: uppercase;">Description</th>
                                <th style="text-align: left !important; padding: 12px 15px; font-size: 12px; color: #111827; font-weight: 700; text-transform: uppercase;">Amount</th>
                                <th style="text-align: left !important; padding: 12px 15px; font-size: 12px; color: #111827; font-weight: 700; text-transform: uppercase;">Term</th>
                                <th style="text-align: left !important; padding: 12px 15px; font-size: 12px; color: #111827; font-weight: 700; text-transform: uppercase;">Interest</th>
                                <th style="text-align: left !important; padding: 12px 15px; font-size: 12px; color: #111827; font-weight: 700; text-transform: uppercase;">Date Granted</th>
                        ...
                        <tbody>
                            ...
                            <tr style="border-bottom: 1px solid #374151;">
                                <td style="text-align: left !important; padding: 12px 15px; color: #9ca3af; font-weight: bold;">{{ $loan->id }}</td>
                                <td style="text-align: left !important; padding: 12px 15px; color: #e5e7eb;">{{ $loan->description }}</td>
                                <td style="text-align: left !important; padding: 12px 15px; color: #e5e7eb;">₱{{ number_format($loan->amount, 2) }}</td>
                                <td style="text-align: left !important; padding: 12px 15px; color: #e5e7eb;">{{ $loan->term }} months</td>
                                <td style="text-align: left !important; padding: 12px 15px; color: #e5e7eb;">{{ $loan->interest }}%</td>
                                <td style="text-align: left !important; padding: 12px 15px; color: #e5e7eb;">{{ $loan->dategranted }}</td>
                            ...
                            <tr>
                                <td colspan="7" style="text-align: center; padding: 30px; color: #9ca3af; font-style: italic;">
                                    No loans found{{ $search ? ' matching "' . $search . '"' : '' }}.
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
